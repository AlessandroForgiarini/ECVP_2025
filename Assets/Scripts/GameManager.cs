...
using System.Linq;
using UnityEngine;
using ColorBlindMode = ECVP_2025_Unity_Workshop.ColorFilterSO.ColorBlindMode;
...
namespace ECVP_2025_Unity_Workshop
{
    public class GameManager : MonoBehaviour
    {
        ...
        private void LoadGoblinWave(int index)
        {
            ...
            if (_totalGoblinsToBanishToRemoveFilter == 0)
            {
                var filter = data.blindMode;
                _totalGoblinsToBanishToRemoveFilter = data.totalGoblins / 4;
                ApplyFilter(filter);
            }
        }
        ...
        public void OnGoblinBanished(bool byPlayer)
        {
            ...
            if (byPlayer)
            {
                _totalGoblinsToBanishToRemoveFilter -= 1;
                if (_totalGoblinsToBanishToRemoveFilter < 0)
                {
                    _totalGoblinsToBanishToRemoveFilter = 0;
                }
